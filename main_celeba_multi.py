...
from src.composer import CelebGender, CelebSmile, CelebGlasses, CelebHair
...
parser.add_argument('-lm', type=float, default=1e-3)
...
model_params = {
    ...
    "channels": (3, 8, 8, 16, 16, 32, 32),  # channels in the encoder
...
tasks["CelebHair"] = {
    "composer": CelebHair,
    "key": 0,
    "params": {"n_iter": 2, "in_dims": model_params["in_dims"], "noise": 0.25},
    "datasets": [],
    "dataloaders": [],
