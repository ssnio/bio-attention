...
tasks["RotationChangeDetection"] = {
    ...
    "datasets": [],
    "dataloaders": [],
    # "loss_w": ((1.0, 1.0, 1.0), None),  # labels, masks
    # "loss_s": ((-3, -2, -1), None),  # labels, masks
    "loss_w": ((1.0, 1.0), (1.0, 1.0)),  # labels, masks
    "loss_s": ((-2,  -1),  (-4,   -3)),  # labels, masks
}
...
# eval_log = eval_log[:-1] if tasks["RotationChangeDetection"]["loss_s"][1] is None else eval_log
